...
class MainActivity : AppCompatActivity() {
    ...
    private fun setupBarChart(chart: BarChart) {
        ...
        val marker = MarkerBarChart(this, R.layout.component_marker_bar_chart)
        chart.marker = marker
...
//
//    val barChart: BarChart = findViewById(R.id.bar_chart)
//    setupWeeklyBarChart(barChart)
//}
//
//private fun setupWeeklyBarChart(barChart: BarChart) {
//    // Membuat data dummy
//    val weeklyData = listOf(150f, 300f, 250f, 500f, 800f, 1620f, 280f)
//    val dayLabelOriginal = listOf()
//}